    ...
    <div id="aeronautical-invoice-detail-page" className="min-h-screen bg-[#fafafc] text-slate-900 font-sans pb-16">
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-2 w-full max-w-xl">
            ...
            <div className="flex-1 bg-white border border-slate-200/80 px-4 py-1.5 rounded-lg text-xs font-mono text-slate-500 overflow-hidden text-ellipsis whitespace-nowrap shadow-inner flex items-center space-x-1">
              ...
              <span className="text-emerald-600 font-bold">/aeronautical-invoice-module</span>
            </div>
          </div>
          <div className="hidden lg:flex items-center space-x-3 text-xs font-mono text-slate-400">
            <span className="h-1.5 w-1.5 bg-emerald-500 rounded-full animate-ping" />
            <span>Financial Integrity Protocol Secured</span>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="inline-flex items-center space-x-2 bg-emerald-50 border border-emerald-150 text-emerald-700 px-4 py-2 rounded-2xl text-xs font-mono font-bold tracking-wider uppercase">
            <span className="h-2 w-2 rounded-full bg-emerald-500 animate-pulse" />
            <span>Financial Suite active</span>
          </div>
        </div>
